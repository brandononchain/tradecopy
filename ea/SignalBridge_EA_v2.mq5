//+------------------------------------------------------------------+
//|  SignalBridge EA v2 — MQL5                                       |
//|  Listens for HTTP orders from the SignalBridge relay server      |
//|  Install in MQL5/Experts/ and attach to any chart               |
//+------------------------------------------------------------------+
#property copyright "SignalBridge"
...
// ─── Input parameters ──────────────────────────────────────────────
input string   ApiKey        = "YOUR_API_KEY";   // SignalBridge API key
...
int OnInit() {
   ...
   Print("SignalBridge EA started. Relay: ", RelayHost, " Magic: ", MagicNumber);
...
void ProcessOrder(string obj) {
   ...
   if (EnableLogging)
      Print("SignalBridge: ", (type==0?"BUY":"SELL"), " ", symbolStr, " lots=", lots,
            " SL=", sl, " TP=", tp, " [", orderId, "]");
