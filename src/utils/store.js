  ...
  _bootstrapDemo() {
    ...
    const user = {
      ...
      connectors: {
        ...
        dxtrade:   { type: 'dxtrade',   host: process.env.DXTRADE_HOST    || 'https://broker.dxtrade.com', apiKey: process.env.DXTRADE_API_KEY || '', accountId: process.env.DXTRADE_ACCOUNT_ID || '' },
